 ...
 */
LinkedList* ll_newLinkedList(void) //Crea un nuevo LL y lo retorna
{
    ...
    return this; //Retorna el LL creado con size inicializado en 0 y el primer nodo inicializado en NULL
}
...
static Node* getNode(LinkedList* this, int nodeIndex)
{
    ...
    if(this != NULL) //Verifico que this sea distinto de NULL
    {
        if (nodeIndex >= 0 && nodeIndex < ll_len(this))
        {
            ...
            for(i = 0; i < nodeIndex; i++) //Recorro hasta que encuentre el indice a buscar
            {
